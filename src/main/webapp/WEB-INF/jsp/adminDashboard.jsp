...
<head>
	...
	<body>
		...
		<div class="dashboard-section">
			<c:url value="CreateNewTopic" var="createNewTopicURL" />
			<a href="${createNewTopicURL}">Create New Topic</a><br>
			<c:url value="/CreateTutorial" var="createTutorialURL" />
			<a href="${createTutorialURL}">Create Tutorial</a>
		</div>
		<div class="dashboard-section">
			<h2>More content</h2>
			<p>
